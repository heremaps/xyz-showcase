...
var bgLayer = new here.xyz.maps.layers.MVTLayer({
    ...
    style: {
        ...
        styleGroups: {
            ...
            'places': [{zIndex: 8,type: 'Text',text: (f) => f.properties.name,stroke: 'white',fill: 'black',font: "18px sans-serif",strokeWidth: 4,collide: false,alignment: 'viewport', priority: 1}]
        },
